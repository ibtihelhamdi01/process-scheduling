...
ExecutedTask* multilevel_wrapper(process *proc, int proc_count, int *executed_count, options ops) {
    return get_multilevel_output(ops.quantum, proc, proc_count, executed_count);
}
