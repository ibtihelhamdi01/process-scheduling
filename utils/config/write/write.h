...
void generate_config_with_comments(const char* filename, options ops, char *max_proc_range, char *exec_range, char *priority_range, char *arrival_range); // NOUVELLE
